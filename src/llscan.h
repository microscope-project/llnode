...
class FindReferencesCmd : public CommandBase {
 public:
  ...
  class ReferenceScanner : public ObjectScanner {
   public:
    ReferenceScanner(LLScan* llscan, v8::Value search_value): llscan_(llscan), search_value_(search_value) {}
  ...
  class PropertyScanner : public ObjectScanner {
   public:
    PropertyScanner(LLScan* llscan, std::string search_value) : llscan_(llscan), search_value_(search_value) {}
  ...
  class StringScanner : public ObjectScanner {
   public:
    StringScanner(LLScan* llscan, std::string search_value) : llscan_(llscan), search_value_(search_value) {}
